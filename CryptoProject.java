...
public class CryptoProject {
	...
	public static void main(String[] args) throws SQLException {
        ...
        String fullFilepath = "C:\\Users\\vanha\\eclipse-workspace\\ProgLanguages\\src\\assignments\\dictionary.txt";
        int lines = 0;
        try {
...
//            System.out.println("Common spam words: ");
//            for(int i = 0; i < lines; i++) {
//            	if(spamWordFreq[i] > 1) {
//            		System.out.println(dictionary[i] + ": " + spamWordFreq[i]);
//            	}
//            }
//            System.out.println("\n\n\nCommon ham words: ");
//            for(int i = 0; i < lines; i++) {
//            	if(hamWordFreq[i] > 1) {
//            		System.out.println(dictionary[i] + ": " + hamWordFreq[i]);
//            	}
//            }
            Scanner scan = new Scanner(System.in);
            double spamLikelihood = totalSpamMessages / (totalHamMessages + totalSpamMessages);
            //System.out.println(spamLikelihood);
